...
const Cart = () => {
  ...
  return (
    <div className="max-w-container max-w-full px-6 dark:bg-gray-800 dark:text-white">
      ...
      {products.length > 0 ? (
        <div className="pb-20">
          <div className="w-full h-20 bg-[#F5F7F7] dark:bg-gray-800 dark:text-white hidden lgl:grid grid-cols-5 place-content-center px-6 text-lg font-titleFont font-semibold">
